...
- [ ] rewrite `filetree/commands`.
  - [ ] filesystem operations
    ...
    - [x] move
    - [x] copy
    - [ ] open with window\_picker
  - [x] clipboard operations
    - [x] clipboard
    - [x] paste\_from\_clipboard: [Breaking Changes](#breaking-changes---commoncommandspastefromclipboard)
  - [ ] search operations
  - [ ] git operations
...
- [x] Debounce.
  - [x] Done on pathlib side.
- [x] watch with fs\_watch
- [ ] watch with tree update (for users without fs\_watch)
  - [ ] BufWritePost
...
This is where [nvim-nio](https://github.com/nvim-neotest/nvim-nio) comes handy, but this is a neat wrapper around lua coroutines, so let's learn from the ground up.
...
[nvim-nio](https://github.com/nvim-neotest/nvim-nio) provides building blocks to implement this coroutine system with [`nio.wrap`](https://github.com/nvim-neotest/nvim-nio#third-party-integration).
