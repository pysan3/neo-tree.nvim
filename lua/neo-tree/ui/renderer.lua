...
M.clean_invalid_neotree_buffers = function(force)
  ...
  for _, buf in ipairs(vim.api.nvim_list_bufs()) do
    ...
    vim.print(string.format([[bufname: %s]], vim.inspect(bufname)))
    vim.print(string.format([[neotree_buffer_name: %s]], vim.inspect(neotree_buffer_name)))
    ...
    if neotree_buffer_name and not is_valid_neotree then
      ...
      if invalid_tree_name ~= "filesystem" then -- prioritize filesystem source as that is mostly wanted
